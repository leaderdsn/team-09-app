...
1 контрольная точка (начало теста) - 14,49 МБ
2 контрольная точка (конец теста) - 14,58 МБ

![memory test](./packages/client/src/assets/images/Memory.jpg)

### Результаты анализа:

По результатам анализа отмечен прирост выделенной памяти на 0,62% или 0,09 МБ, что является незначительным и не оказывает существенного влияния на производительность приложения.
